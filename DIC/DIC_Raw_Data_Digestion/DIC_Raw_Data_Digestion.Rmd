...
#run this step to get every third time stamp for batch runs of CRMs. Depending on the number of batches, you will have to adjust the number you're selecting (could be all). 
dic_crm <- dic_raw %>%
  filter(str_detect(`Sample Name`, "^C") & !str_detect(`Sample Name`, "junk"))
